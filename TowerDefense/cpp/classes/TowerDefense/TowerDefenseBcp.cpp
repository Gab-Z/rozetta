...
void TowerDefense::setLevel( Level<std::vector<Tile*>>* _level ){
  level = _level;
}
*/
...
NAN_METHOD(TowerDefense::New) {
  ...
  if( info.Length() == 4 ){
    ...
    towerDef->level = new Level<std::array<Tile*, 22500>>( info[0]->IntegerValue(), info[1]->IntegerValue(), converter::jsArrayToVectorInt( v8::Local<v8::Array>::Cast( info[ 2 ] ) ), converter::jsArrayToVectorInt( v8::Local<v8::Array>::Cast( info[ 3 ] ) ) );
    ...
    */
    towerDef->level = new Level<std::array<Tile*, 22500>>(  info[0]->IntegerValue(), info[1]->IntegerValue(),//width, height
                                      converter::jsArrayToVectorInt( v8::Local<v8::Array>::Cast( info[ 2 ] ) ),//startPoints
                                      converter::jsArrayToVectorInt( v8::Local<v8::Array>::Cast( info[ 3 ] ) ),//endPoints
                                      converter::jsArrayToVectorInt( v8::Local<v8::Array>::Cast( info[ 4 ] ) ) );//floorIds
  ...
  /*
  std::vector<int>st = { 0, 0 };
  std::vector<int>et = { 1, 1 };
  Level<std::array<Tile*, 100>> arrL( 10, 10, st, et );
  Level<std::vector<Tile*>> vecL( 10, 10, st, et );
  */
...
*/
NAN_METHOD( TowerDefense::runTest ){
  int iterations = 10;
  TowerDefense* self = Nan::ObjectWrap::Unwrap<TowerDefense>( info.This() );
